    ...
    redux.field_objects.color.init = function( selector ) {
        ...
        $( selector ).each(
            function() {
                ...
                el.find( '.redux-color-alpha-init' ).wpColorPicker(
                    {
                        ...
                        clear: function( e, ui ) {
                            $( this ).val( '' );
                            redux_change( $( this ).parent().find( '.redux-color-alpha-init' ) );
                        }
                    }
                );

                el.find( '.redux-color-alpha' ).on(
                    'focus', function() {
                ...
                el.find( '.color-transparency' ).on(
                    'click', function() {
                        if ( $( this ).is( ":checked" ) ) {
                            ...
                            el.find( '.redux-saved-color-alpha' ).val( $( '#' + $( this ).data( 'id' ) ).val() );
                            ...
                            if ( el.find( '#' + $( this ).data( 'id' ) ).val() === 'transparent' ) {
                                var prevColor = $( '.redux-saved-color-alpha' ).val();
