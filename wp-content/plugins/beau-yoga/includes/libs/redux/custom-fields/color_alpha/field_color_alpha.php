...
if ( ! class_exists( 'ReduxFramework_color_alpha' ) ) {
	...
	class ReduxFramework_color_alpha {
		...
		public function render() {
			...
			$input .= 'class="color-picker redux-color-alpha redux-color-alpha-init ' . $this->field['class'] . '"  ';
			...
			$input .= '/>';
			echo $input;
			echo '<input type="hidden" class="redux-saved-color-alpha" id="' . $this->field['id'] . '-saved-color' . '" value="">';
		...
		public function enqueue() {
			...
			wp_enqueue_script(
				...
				trailingslashit( BEAU_CORE_URL ) . 'includes/libs/redux/custom-fields/color_alpha/wp-color-picker-alpha.min.js',
				array( 'wp-color-picker' ),
				'1.2'
			);
			wp_enqueue_script(
				'redux-field-color-js',
				trailingslashit( BEAU_CORE_URL ) . 'includes/libs/redux/custom-fields/color_alpha/field_color_alpha.js',
